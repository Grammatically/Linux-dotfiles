...
hl.bind(mainMod .. " + H",     hl.dsp.exec_cmd(launchPrefix .. TERMINAL))
...
hl.bind(mainMod .. " + SHIFT + G", hl.dsp.exec_cmd("flatpak run app.grayjay.Grayjay")) -- Youtube
hl.bind(mainMod .. " + SHIFT + R", hl.dsp.exec_cmd("flatpak run org.vinegarhq.Sober")) -- Roblox
hl.bind(mainMod .. " + SHIFT + M",     hl.dsp.exec_cmd("flatpak run app.xmcl.voxelum")) -- Minecraft
hl.bind(mainMod .. " + SHIFT + C",     hl.dsp.exec_cmd("code")) -- VS Code
hl.bind(mainMod .. " + SHIFT + D",     hl.dsp.exec_cmd("discord"))
hl.bind(mainMod .. " + SHIFT + S",     hl.dsp.exec_cmd("steam"))
hl.bind(mainMod .. " + SHIFT + L",     hl.dsp.exec_cmd("flatpak run org.localsend.localsend_app/x86_64/stable"))
hl.bind(mainMod .. " + SHIFT + O",     hl.dsp.exec_cmd("flatpak run md.obsidian.Obsidian"))
hl.bind(mainMod .. " + SHIFT + N",     hl.dsp.exec_cmd("gnome-text-editor"))
...
-- hl.bind("F13", hl.dsp.exec_cmd(noctCall .. "volume muteInput"),  { locked = true, repeating = true })
